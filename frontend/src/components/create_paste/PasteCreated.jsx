const PasteCreated = ({ pasteUrl, copied, copyToClipboard, error, copyError }) => {
  return (
    <div className="flex flex-col flex-1 px-6 py-5">
      <div className="flex-1 overflow-auto dark:bg-gray-700 dark:text-gray-100 p-4 rounded-lg flex items-center justify-center">
        <div className="border-2 border-dashed border-gray-400 rounded-lg p-6 w-full h-full flex flex-col items-center justify-center text-center">
          ...
          <p className="dark:text-gray-300 mb-4">Your pasted URL:</p>
          <pre className="dark:bg-gray-500 dark:text-gray-100 px-4 py-3 rounded-lg whitespace-pre-wrap inline-block">
            {pasteUrl}
          </pre>
        </div>
      </div>
